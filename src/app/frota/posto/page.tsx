      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="mt-3 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h1 className="text-xl font-semibold text-[color:var(--color-text-strong)] sm:text-2xl">Administração da rede credenciada</h1>
        ...
        <Card className="mt-6">
          <div className="border-b border-[color:var(--color-border)] px-5 py-4">
            <h2 className="text-base font-semibold text-[color:var(--color-text-strong)]">Faturamento da rede · 12 meses (R$)</h2>
          </div>
        ...
        <Card id="postos" className="mt-6 overflow-hidden scroll-mt-20">
          <div className="flex items-center justify-between border-b border-[color:var(--color-border)] px-5 py-4">
            ...
            <button className="inline-flex items-center gap-1.5 rounded-md bg-[color:var(--color-brand)] px-3 py-2 text-xs font-medium text-black hover:bg-[color:var(--color-brand-deep)] hover:text-[color:var(--color-text-strong)]">
                ...
                {PRECOS_POSTOS.map((p, i) => (
                  <tr key={i}>
                    <td className="px-5 py-3">
                      <span className="inline-flex items-center gap-2 font-medium text-[color:var(--color-text-strong)]">
        ...
        <Card id="cartoes" className="mt-6 overflow-hidden scroll-mt-20">
          <div className="flex items-center justify-between border-b border-[color:var(--color-border)] px-5 py-4">
            <h2 className="text-base font-semibold text-[color:var(--color-text-strong)]">Cartões emitidos</h2>
            <Link href="/cartoes/novo" className="inline-flex items-center gap-1.5 rounded-md bg-[color:var(--color-brand)] px-3 py-2 text-xs font-medium text-black hover:bg-[color:var(--color-brand-deep)] hover:text-[color:var(--color-text-strong)]">
        ...
        <Card className="mt-6 overflow-hidden">
          <div className="border-b border-[color:var(--color-border)] px-5 py-4">
            <h2 className="text-base font-semibold text-[color:var(--color-text-strong)]">Novos cartões emitidos</h2>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-[color:var(--color-border)]">
                {novos.map((n, i) => (
                  <tr key={i}>
                    <td className="px-5 py-3 font-mono text-[color:var(--color-text-strong)]">{n.usuario}</td>
        ...
        <Card id="precos" className="mt-6 overflow-hidden scroll-mt-20">
          <div className="border-b border-[color:var(--color-border)] px-5 py-4">
            <h2 className="text-base font-semibold text-[color:var(--color-text-strong)]">Transações recentes</h2>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
              ...
              <tbody className="divide-y divide-[color:var(--color-border)]">
                {txs.map((t, i) => (
                  <tr key={i}>
                    ...
                    <td className="px-5 py-3 text-[color:var(--color-text-strong)]">{t.posto}</td>
                    ...
                    <td className="px-5 py-3 text-right font-mono text-[color:var(--color-text-strong)]">{formatNumber(t.litros)} L</td>
                    <td className="px-5 py-3 text-right font-mono text-[color:var(--color-text-strong)]">{formatBRL(t.valor)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
