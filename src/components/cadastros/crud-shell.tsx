...
export function EmptyState({
  ...
  return (
    <div className="px-6 py-16 text-center">
      ...
      <h3 className="mt-3 text-base font-semibold text-[color:var(--color-text-strong)]">{title}</h3>
      {description ? (
  ...
  return (
    <>
      ...
      <Card className="max-w-2xl p-6">
        <h2 className="text-base font-semibold text-[color:var(--color-text-strong)]">{title}</h2>
        {subtitle ? (
