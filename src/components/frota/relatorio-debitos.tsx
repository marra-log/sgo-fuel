      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-[color:var(--color-border)] px-5 py-3">
        <div className="flex items-center gap-1.5 rounded-md border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)] px-2.5 py-1.5">
          ...
          <input
            ...
            className="w-48 bg-transparent text-xs text-white outline-none placeholder:text-[color:var(--color-muted)]"
          />
        </div>
        <select value={estab} onChange={(e) => setEstab(e.target.value)} className="rounded-md border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)] px-2 py-1.5 text-xs text-white outline-none">
        ...
        <table className="w-full text-sm">
          ...
          <tfoot>
            <tr className="border-t border-[color:var(--color-border)] bg-[color:var(--color-surface-2)]">
              <td className="px-4 py-3 font-semibold text-white" colSpan={6}>Total filtrado</td>
              <td className="px-4 py-3 text-right font-mono text-white">{formatNumber(Math.round(totalLitros))}</td>
